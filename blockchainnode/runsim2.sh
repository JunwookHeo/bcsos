...
then
    ...
    tmux send-keys -t MLDC:0.0 'go run blockchainnode.go -mode=pan -type=0 -port=7001' C-m
    tmux send-keys -t MLDC:0.1 'go run blockchainnode.go -mode=pan -type=0 -port=7002' C-m
    tmux send-keys -t MLDC:0.2 'go run blockchainnode.go -mode=pan -type=0 -port=7003' C-m
    tmux send-keys -t MLDC:0.3 'go run blockchainnode.go -mode=pan -type=0 -port=7004' C-m
    # tmux send-keys -t MLDC:0.4 'go run blockchainnode.go -mode=pan -type=1 -port=7005' C-m
    # tmux send-keys -t MLDC:0.5 'go run blockchainnode.go -mode=pan -type=1 -port=7006' C-m
    # tmux send-keys -t MLDC:0.6 'go run blockchainnode.go -mode=pan -type=2 -port=7007' C-m 
    # tmux send-keys -t MLDC:0.7 'go run blockchainnode.go -mode=pan -type=3 -port=7008' C-m
    ...
    tmux send-keys -t MLDC:1.0 'go run blockchainnode.go -mode=pan -type=1 -port=7011' C-m
    ...
    tmux send-keys -t MLDC:1.3 'rm bc_dummy.db' C-m
    tmux send-keys -t MLDC:1.3 'go run blockchainsim.go' C-m
