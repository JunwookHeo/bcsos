...
then
    ...
    tmux send-keys -t MLDC:0.4 'go run blockchainnode.go -mode=pan -type=1 -port=7011' C-m
    tmux send-keys -t MLDC:0.5 'go run blockchainnode.go -mode=pan -type=1 -port=7012' C-m
    tmux send-keys -t MLDC:0.6 'go run blockchainnode.go -mode=pan -type=3 -port=7031' C-m 
  #  tmux send-keys -t MLDC:0.7 'go run blockchainnode.go -mode=pan -type=3 -port=7008' C-m
    ...
    tmux send-keys -t MLDC:0.7 'rm bc_dummy.db' C-m
