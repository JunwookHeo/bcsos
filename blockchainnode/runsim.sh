...
then
    ...
    tmux send-keys -t MLDC:0.4 'go run blockchainnode.go -mode=pan -type=0 -port=7005' C-m
    tmux send-keys -t MLDC:0.5 'go run blockchainnode.go -mode=pan -type=0 -port=7006' C-m
    tmux send-keys -t MLDC:0.6 'go run blockchainnode.go -mode=pan -type=0 -port=7007' C-m 
    tmux send-keys -t MLDC:0.7 'go run blockchainnode.go -mode=pan -type=0 -port=7008' C-m
    ...
    tmux send-keys -t MLDC:1.4 'go run blockchainnode.go -mode=pan -type=2 -port=7021' C-m
